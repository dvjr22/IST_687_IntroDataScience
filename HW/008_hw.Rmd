...
# I would create a model with Percipitation and Antelope Population and see how well that 
#performs on it's own
# b/c in model 3, those were the most significant variables.  Based on that result, I'd make 
# a choice between model 3 and the new model.
