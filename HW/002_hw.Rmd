...
bestCars = myCars[myCars$mpg > bestMPG,] # I only want the cars that have best mpg
bestComboCar = bestCars[bestCars$hp == max(bestCars$hp), ] # Now i want the best hp in that slice
